function [file_name,Img,DVCpara] = ReadImage3_v2_zeroInitGuess(varargin)
...
InitFFTMethod = 1; % funParaInput('InitFFTMethod');
...
if numImages > 2
    ...
    NewFFTSearch = 0; % funParaInput('NewFFTSearch'); % Use last frame as init guess or not
