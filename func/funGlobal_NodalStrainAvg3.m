%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Compute strain field in the FE-based global DVC method   %
% Author: Jin Yang                                         %
% Last date modified: 2019.03; 2020.10                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [F,StrainGaussPt,CoordsGaussPt] = funGlobal_NodalStrainAvg3(DVCmesh,U,GaussPtOrder)
...
StrainGaussPt = zeros(2^DIM*size(elementsFEM,1),9); CoordsGaussPt = zeros(2^DIM*size(elementsFEM,1),3); % Number of Gauss Pt: 2^DIM
